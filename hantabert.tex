...
atas \emph{encoder} DNABERT-2, kemudian mempercabangkan tiga kepala
...
(\emph{Rodent}/\emph{Human}/\emph{Others}/\emph{Unknown}), dan koordinat
...
Kolom \emph{geo\_label\_broad} sumber mengandung kekeliruan masif dan
...
(1--23) dapat diatur per tugas, lengkap dengan \emph{confidence score}
...
serta panduan reproduksi tahap demi tahap.
...
tanpa tanda \emph{overfitting} jelas.
...
\emph{O.\ puumalaense}) terprediksi nyaris sempurna, dan kesalahan
...
dari sekuens; akurasi $80{,}5\%$ kemungkinan adalah \emph{upper bound}
...
DNA/RNA atau FASTA dan mengembalikan prediksi probabilistik per tugas
